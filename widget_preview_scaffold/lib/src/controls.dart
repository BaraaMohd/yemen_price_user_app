...
/// A button that toggles the widget inspector.
class WidgetInspectorToggleButton extends StatelessWidget {
  const WidgetInspectorToggleButton({super.key});
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, enableWidgetInspector, _) {
        return _ControlDecorator(
          child: IconButton(
            tooltip:
                '${enableWidgetInspector ? 'Disable' : 'Enable'} widget inspector',
            onPressed: _toggleInspector,
            icon: Icon(
              enableWidgetInspector ? Icons.visibility_off : Icons.visibility,
            ),
            color: Colors.black,
          ),
        );
