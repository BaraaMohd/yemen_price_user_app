      ...
      builder: (context, enableWidgetInspector, child) {
        ...
        if (enableWidgetInspector) {
          return WidgetInspector(
            // Inspector controls are wired up via the WidgetInspectorToggleButton
            // in the preview environment controls. These buttons would be rendered
            // on top of the previewed widget, so don't display them.
